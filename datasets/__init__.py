...
def load_data(
    ...
    if not test_only:
        if dataset == 'mri2pet':
            ...
            trainset = Mri2petDataset(img_size=image_size, stage='train', target_modality=target_modality)
            valset = Mri2petDataset(img_size=image_size, stage='val', target_modality=target_modality)
            if include_test:
